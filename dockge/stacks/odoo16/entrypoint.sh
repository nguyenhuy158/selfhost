...
# Không đặt password mặc định ở đây — compose đã truyền PASSWORD vào từ .env.
# Thiếu biến thì dừng hẳn, hơn là chạy tiếp bằng một password hardcode.
: ${PASSWORD:=${DB_ENV_POSTGRES_PASSWORD:=${POSTGRES_PASSWORD:?thieu PASSWORD/POSTGRES_PASSWORD, xem .env.example}}}
